all: build/laser.o build/Symbol/SymbolUTF8.o build/Symbol/SomeUTF8Symbols.o build/Symbol/Symbol.o build/ANSILinux/TIOAL_PropANSI_SymbolUTF8.o build/ANSILinux/WSL_SymbolUTF8.o build/boxman.o build/main.o
...
build/boxman.o: /home/shkiper/Код/Blessings/boxman.cpp \
 ...
 /home/shkiper/Код/Blessings/demos.hpp
	mkdir -p build/
	clang --std=c++11 -c boxman.cpp -o build/boxman.o -lboost_filesystem -lboost_system
