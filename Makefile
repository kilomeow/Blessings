...
install:
	...
	mkdir -p $(HOME)/.prefix/usr/include/blessings/symbol/
	cp symbol/string_utf8.hpp $(HOME)/.prefix/usr/include/blessings/symbol/string_utf8.hpp
	mkdir -p $(HOME)/.prefix/usr/include/blessings/symbol/
	...
	mkdir -p $(HOME)/.prefix/usr/include/blessings/symbol/
	cp symbol/symbol_utf8_impl.hpp $(HOME)/.prefix/usr/include/blessings/symbol/symbol_utf8_impl.hpp
	mkdir -p $(HOME)/.prefix/usr/include/blessings/
